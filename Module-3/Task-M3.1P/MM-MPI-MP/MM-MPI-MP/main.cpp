...
void writeMatricesToDisk() {
  ofstream outputFileStream("/Volumes/Shared Folders/Module-3/DerivedData/MPI Matrix Multiplication/Build/Products/Debug/MM-MPI-MP.txt");
...
int main(int argc, const char * argv[]) {
  ...
  printf("Processor: %s, rank: %d out of %d processors, Open MP threads: %i\n", processorName, worldRank, worldSize, omp_get_max_threads());
